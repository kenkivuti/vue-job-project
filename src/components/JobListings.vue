        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="bg-white rounded-xl shadow-md relative">
            <div class="p-4">
              ...
              <div class="mb-5">
                ...
                in Nairobi, Kenya. The ideal candidate will have strong skills in
                HTML, CSS, and JavaScript...
              </div>

              <h3 class="text-green-500 mb-2">Ksh.70 - 80K / Month</h3>
          ...
          <div class="bg-white rounded-xl shadow-md relative">
            <div class="p-4">
              ...
              <div class="mb-5">
                Join our team as a Front-End Developer in sunny Nairobi, Kenya. We
                are looking for a motivated individual with a passion...
              </div>

              <h3 class="text-green-500 mb-2">70K - 80K / Month</h3>
          ...
          <div class="bg-white rounded-xl shadow-md relative">
            <div class="p-4">
              ...
              <div class="mb-5">
                ...
                vibrant Nairobi, Kenya, and work on exciting projects that make a
                difference...
              </div>

              <h3 class="text-green-500 mb-2">Ksh.70K - 80K / Month</h3>
